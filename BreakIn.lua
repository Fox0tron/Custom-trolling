...
if game.PlaceId ~= 13864667823 then
	if game.PlaceId == 14775231477 or game.PlaceId == 13864667823 then
	...
	-- Free Gamepasses (LOBBY)
		...
		game:GetService("Players").LocalPlayer:Kick("Join a game first.")
	end
else
    	-- Floating Part
...
-- Tables
	...
	Tab:AddTextbox({
  	...
  	Tab:AddTextbox({
		...
		Callback = function(Value)
			pcall(function()
				Delete(game:GetService("Workspace"):FindFirstChild(tostring(Value)).Humanoid)
			end)
		end	  
	})
		...
		Callback = function(Value)
			pcall(function()
				Delete(game:GetService("Workspace"):FindFirstChild(tostring(Value)).HumanoidRootPart)
			end)
		end	  
	})
